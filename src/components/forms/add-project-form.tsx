...
export function AddProjectForm({ employees, clients }: AddProjectFormProps) {
  ...
  function onSubmit(data: Inputs) {
    startTransition(async () => {
      try {
        data.Inicio = data.date_start_end.from.toISOString()
        data.Termino = data.date_start_end.to.toISOString()
